...
//     {
//       id: 1,
//       image: "/images/56308c2ac234ce5d7300f83f7e7ddc7e.jpg",
//       title: "Natural Wellness",
//       subtitle: "Holistic healing through centuries-old natural remedies"
//     },
//     {
//       id: 2,
//       image: "/images/07932ab86b0b6c0f7197db770c74f139.jpg", 
//       title: "Team Wellness",
//       subtitle: "Together we achieve optimal wellness and balance"
//     },
//     // {
//     //   id: 3,
//     //   image: "/images/4a84ab4b2a257f7f320a89c6109aa12a.jpg",
...
//                       Welcome to Ayur4Life Herbals India
//                     </h1>
...
//                       <Button as={Link} to="/all-products" variant="success" size="lg" className="me-3 hero-btn">
//                         Shop Now
//                       </Button>
...
import React, { useState, useEffect} from 'react';
import { Container, Row, Col, Card, Button, Form, Alert, Spinner, Carousel, Modal } from 'react-bootstrap';
import { Link, useSearchParams,useNavigate } from 'react-router-dom';
import "./home.css";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faHeart, faShoppingCart, faStar,faQuoteLeft, faLeaf, faShieldAlt, faTimes } from '@fortawesome/free-solid-svg-icons';
import { faHeart as farHeart } from '@fortawesome/free-regular-svg-icons';
import { useCart } from '../contexts/CartContext';
import { useWishlist } from '../contexts/WishlistContext';
import UserLayout from '../layouts/UserLayout';
...
const Home = () => {
  ...
  const [selectedTrustItem, setSelectedTrustItem] = useState(null);
  ...
  // Trust items data with detailed information
  const trustItems = [
    {
      id: 1,
      icon: faShieldAlt,
      title: "Secure Shopping",
      shortDescription: "100% secure payment",
      detailedDescription: "Your security is our top priority. We use industry-standard SSL encryption to protect your personal and payment information. All transactions are processed through secure payment gateways with fraud protection.",
      features: [
    ...
    },
    {
      ...
      shortDescription: "Genuine Ayurvedic",
      detailedDescription: "We guarantee 100% authentic Ayurvedic products sourced directly from trusted manufacturers and certified suppliers. All our products undergo rigorous quality checks to ensure purity and effectiveness.",
      features: [
        "Direct from certified suppliers",
    ...
    },
    {
      ...
      icon: faShoppingCart,
      title: "Free Shipping",
      shortDescription: "On orders above ₹999",
      detailedDescription: "Enjoy free shipping on all orders above ₹999. For orders below this amount, we charge a nominal shipping fee. We deliver across India with multiple shipping partners for reliable and timely delivery.",
      features: [
    ...
    },
    {
      ...
      shortDescription: "Easy return policy",
      detailedDescription: "Not satisfied with your purchase? We offer a hassle-free 30-day return policy. Products must be unopened and in original packaging. Refunds are processed within 5-7 business days.",
      features: [
  ...
  const handleTrustItemClick = (trustItem) => {
    setSelectedTrustItem(trustItem);
    setShowTrustModal(true);
  };

  const handleCloseTrustModal = () => {
    setShowTrustModal(false);
    setSelectedTrustItem(null);
  };
  ...
  return (
    <UserLayout>
          ...
          <Row className="text-center">
            {trustItems.map((item) => (
              <Col lg={3} md={6} className="mb-4" key={item.id}>
                <div 
                  className="trust-item clickable-trust-item" 
                  onClick={() => handleTrustItemClick(item)}
                >
                  <div className="trust-icon">
      ...
      {/* Trust Item Modal */}
      <Modal show={showTrustModal} onHide={handleCloseTrustModal} centered size="lg">
        <Modal.Header className="border-0 pb-0">
          <Modal.Title className="w-100 text-center">
            {selectedTrustItem && (
              <>
                <div className="modal-icon mb-3">
                  <FontAwesomeIcon icon={selectedTrustItem.icon} />
                </div>
          ...
          <Button 
            variant="link" 
            className="position-absolute top-0 end-0 p-3 text-dark" 
            onClick={handleCloseTrustModal}
          >
        ...
        <Modal.Body className="pt-0">
          {selectedTrustItem && (
            <>
              <p className="text-muted text-center mb-4">{selectedTrustItem.shortDescription}</p>
              <p>{selectedTrustItem.detailedDescription}</p>
              
              <h5 className="mt-4 mb-3">Key Features:</h5>
              <ul className="list-unstyled">
                {selectedTrustItem.features.map((feature, index) => (
                  <li key={index} className="mb-2">
                    <FontAwesomeIcon icon={faHeart} className="text-success me-2" />
                    {feature}
                  </li>
                ))}
              </ul>
        ...
        <Modal.Footer className="border-0">
          <Button variant="success" onClick={handleCloseTrustModal}>
            Got It
          </Button>
        </Modal.Footer>
      </Modal>
